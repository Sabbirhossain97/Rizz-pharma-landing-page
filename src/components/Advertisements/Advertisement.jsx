...
function Advertisement() {
    return (
        <div className='min-h-[300px] sm:h-[500px] md:min-h-[800px] mt-[160px] px-4 md:px-6 custom1:px-0 max-w-screen w-full bg-no-repeat bg-center bg-cover md:bg-top flex justify-center' style={{ backgroundImage: "url('src/assets/service.png')" }}>
