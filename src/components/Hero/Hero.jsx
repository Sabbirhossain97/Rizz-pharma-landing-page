    ...
    return (
        ...
        >
            ...
            <div className='max-w-[1170px] mx-auto mt-[53px]'>
                ...
                <div className='text-center mt-[73px] hero-custom-text3 text-white text-[48px] font-normal capitalize leading-[57.6px]'>
                    <h1>Shop by <span className='hero-custom-text4'>Category</span></h1>
                </div>
            </div>
        </section>
    )
